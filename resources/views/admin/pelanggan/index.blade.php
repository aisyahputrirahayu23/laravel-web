                ...
                <div class="card-body">
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('pelanggan.edit', $item->pelanggan_id) }}"
                                                ...
                                                <svg class="icon icon-xs me-2" data-slot="icon" fill="none"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582
                                                    ...
                                                    <svg class="icon icon-xs me-2" data-slot="icon" fill="none"
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107
                                                                ...
                                                                1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.
                                                                916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32
                        ...
                        <div class="mt-3">
                            ...
                            {{-- {{ $dataPelanggan->links('agination::simple-bootstrap-5') }} --}}
                        </div>
                    </div>
                </div>
            </div>
