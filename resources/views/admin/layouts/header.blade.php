        ...
        <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav align-items-center">
                <li class="nav-item dropdown">
                    <a class="nav-link nav-link-toggle dropdown-toggle pt-1 px-0" href="#" role="button"
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    5 0 00-4.546 2.916A5 5 0 0010 17a5 5 0 004.546-2.084A5 5 0 0010 11z"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11.49 3.17c.38-.174.59.349.349.59 0 0-1.373 2.746-1.838 3.662-1.838
                                    3.662-2.978 2.106-1.561 2.978-.815.174-.59-.349-.349-.59 0 0 1.373-2.746
                                    1.838-3.662 1.838-3.662 2.978-2.106 1.561-2.978z">
                                </path>
                                <path
                                    d="M11.49 3.17c.38-.174.59.349.349.59 0 0-1.373 2.746-1.838 3.662-1.838
                                    3.662-2.978 2.106-1.561 2.978-.815.174-.59-.349-.349-.59 0 0 1.373-2.746
                                ...
                                <path
                                    d="M11.49 3.17c.38-.174.59.349.349.59 0 0-1.373 2.746-1.838 3.662-1.838
                                    3.662-2.978 2.106-1.561 2.978-.815.174-.59-.349-.349-.59 0 0 1.373-2.746
                                    1.838-3.662 1.838-3.662 2.978-2.106 1.561-2.978zM13 3a3 3 0 100 6 3 3 0 000-6z"
                                    clip-rule="evenodd"></path>
                            </svg>
                            Settings
                        </a>
